...
class EcoImpact(BasePage):
    ...
    def energy_take_screenshot(self):
        self.browser.find_element(*self.ENERGY_COUNTER).screenshot(f'./{self.SCREENSHOT_DIR}/energy_counter.png')

    def water_take_screenshot(self):
        self.browser.find_element(*self.WATER_COUNTER).screenshot(f'./{self.SCREENSHOT_DIR}/water_counter.png')

    def co2_take_screenshot(self):
        self.browser.find_element(*self.CO2_COUNTER).screenshot(f'./{self.SCREENSHOT_DIR}/co2_counter.png')
